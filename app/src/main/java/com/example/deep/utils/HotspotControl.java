package com.example.deep.utils;
...
import com.example.deep.data_stream.*;
...
public class HotspotControl {
    ...
    /**
     * Not necessary to {@link HotspotControl} functionality but added here to help {@link ChatActivity} with port number to display connection URL
     */
     ...
     * @param port Port number assigned to {@link com.tml.sharethem.sender.SHAREthemServer}, not used anywhere in {@link HotspotControl} but helps {@link ChatActivity} to display port info
