...
import static com.example.deep.data_stream.ChatService.ShareIntents.SHARE_CLIENT_IP;
import static com.example.deep.data_stream.ChatService.ShareIntents.SHARE_SERVER_UPDATES_INTENT_ACTION;
import static com.example.deep.data_stream.ChatService.ShareIntents.SHARE_SERVER_UPDATE_FILE_NAME;
import static com.example.deep.data_stream.ChatService.ShareIntents.SHARE_SERVER_UPDATE_TEXT;
import static com.example.deep.data_stream.ChatService.ShareIntents.SHARE_TRANSFER_PROGRESS;
import static com.example.deep.data_stream.ChatService.ShareIntents.TYPE;
import static com.example.deep.data_stream.ChatService.ShareIntents.Types.AP_DISABLED_ACKNOWLEDGEMENT;
import static com.example.deep.data_stream.ChatService.ShareIntents.Types.FILE_TRANSFER_STATUS;


/**
 * Manages Hotspot configuration using an instance of {@link HotspotControl} and also deals lifecycle of {@link ChatServer}
...
public class ChatService extends Service {
    ...
    private ChatServer m_fileServer;
...
//                    sendAcknowledgementBroadcast(AP_ENABLED_ACKNOWLEDGEMENT);
     ...
     * @param addStopAction if true STOP action is added to stop {@link ChatService}
     * @return Notification
     */
    ...
    /**
     * Starts {@link ChatServer} and then enables Hotspot with assigned port being part of encoded SSID.
     *
    ...
    private void startFileHostingServer(String[] filePathsTobeServed, int port, final String sender_name) {
        m_fileServer = new ChatServer(getApplicationContext()
    ...
    private static class HotspotChecker extends Handler {
        WeakReference<ChatService> service;

        HotspotChecker(ChatService senderService) {
            this.service = new WeakReference<>(senderService);
        }

        @Override
        public void handleMessage(Message msg) {
            ChatService senderService = service.get();
